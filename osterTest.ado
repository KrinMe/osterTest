...
program define osterTest, rclass
    version 13.0
    syntax varlist(min=1 max=1) [, A(real 0) OUT(string)]
    ...
    di as txt "a        = " as res %9.4f `a'
    di as txt "a in CI? = " as res a_in_ci
